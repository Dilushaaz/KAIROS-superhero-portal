    ...
    <footer className="site-footer cinematic-footer">
      <div className="container footer-inner">
        <div className="footer-left-brand">
          <span className="footer-brand-title">KAIROS</span>
          <span className="footer-pipe">|</span>
          <span className="footer-tagline">GUARDING PEOPLE. EMPOWERING CHANGE.</span>
        </div>
        ...
        <div className="footer-right-meta">
          <div className="footer-legal-links">
            ...
            <a href="#support" className="footer-legal-link">Support</a>
          </div>
